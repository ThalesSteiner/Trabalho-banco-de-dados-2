-- esse script cria a tabela original

create schema o; --o de original

CREATE TABLE o.Tabelona (
    assists INT,
    GameID VARCHAR,
    GameMode VARCHAR(10) NOT NULL CHECK (GameMode IN ('ARAM','CLASSIC')),
    baronKills INT,
    bountyLevel INT CHECK (bountyLevel BETWEEN 0 AND 29),
    champExperience INT CHECK (champExperience BETWEEN 0 AND 43518),
    champLevel INT CHECK (champLevel BETWEEN 1 AND 18),
    championName VARCHAR(20), --nome mais longo atualmente tem 15 letras
    ...
    inhibitorKills INT CHECK (inhibitorKills BETWEEN 0 AND 7),
    ...
    objectivesStolen INT CHECK (objectivesStolen IN (0,1,2,3)),
